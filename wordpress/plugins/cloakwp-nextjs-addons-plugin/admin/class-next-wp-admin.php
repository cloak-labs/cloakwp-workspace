  ...
  { ?>
    <table class="form-table" role="presentation">
      <tbody>
        ...
        self::settings_row('NEXT_WP_LOGOUT_API_ROUTE'); ?>
      </tbody>
    </table>
<?php
  }
  ...
  public function next_wp_settings_init()
  {
    ...
    add_settings_section(
      'config_section',
      __('Configuration Variables', 'next_wp'),
      array($this, 'nextwp_config_section_callback'),
      'next_wp_settings'
    );
  }
  ...
  /**
   * Add NextWP menu item to wordpress admin
   * 
   * @return void
   *
   * @since    0.6.0
  ...
  public function add_admin_menu()
  {
    add_menu_page(
      ...
      'manage_options',
      'next_wp',
      array($this, 'nextwp_options_page'),
  ...
  {
    add_action('admin_init', array($this, 'next_wp_settings_init'));
  }
