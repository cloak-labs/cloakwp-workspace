...
class CloakWP
{
   ...
   *
   * - CloakWP_Loader. Orchestrates the hooks of the plugin.
   * - CloakWP_i18n. Defines internationalization functionality.
   * - CloakWP_Admin. Defines all hooks for the admin area.
  ...
  private function load_dependencies()
  {
     ...
     * core plugin.
     */
    require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-cloakwp-loader.php';

    /**
     * The class responsible for defining internationalization functionality
     * of the plugin.
     */
    require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-cloakwp-i18n.php';
    
    /**
     * The class responsible for defining all ISR functionality
     * 
     */
    require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-cloakwp-isr.php';

    /**
     * The class responsible for defining all ISR functionality
     * 
     */
    require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-cloakwp-preview.php';
    ...
    $this->loader = new CloakWP_Loader();
  }
  ...
  private function define_admin_hooks()
  {
    ...
    $plugin_admin = new CloakWP_Admin($this->get_plugin_name(), $this->get_version());
