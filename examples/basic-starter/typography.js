/* 
  If you wish to apply typography styles to dynamic content such as for a 
  WordPress blog post, simply apply the "prose" CSS class to a parent 
  element, and the following CSS will apply:
 */
