...
const myBlockConfig = {
  'core/heading': { // note: we can override/extend core blocks like so.. here we aren't overriding the heading block's Component or anything else, we're only extending it by adding custom props -- behind the scenes, it does a deep object merge rather than a full object override 
